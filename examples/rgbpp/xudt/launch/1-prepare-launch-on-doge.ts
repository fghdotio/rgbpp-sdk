...
const prepareLaunchCell = async ({
  ...
  const outputs: CKBComponents.CellOutput[] = [
    {
      lock: genRgbppLockScript(buildRgbppLockArgs(outIndex, dogeTxId), isMainnet, BTC_TESTNET_TYPE),
...
prepareLaunchCell({
  outIndex: 1,
  dogeTxId: '5802d2395172f80a18e8637f8c4c91ff213bc60fab0aeeef839f1ea3b95b0177',
  rgbppTokenInfo: RGBPP_TOKEN_INFO,
});

/* 
npx tsx examples/rgbpp/xudt/launch/1-prepare-launch-on-doge.ts
*/
